...
#pragma region Windows Form Designer generated code
        void InitializeComponent(void)
        {
            ...
            this->label4->Text = L"Виконала Куліш Олександра";
            // 
            // label5
            // 
            ...
            this->label5->Text = L"y\'=x+cos(y/7); y(0.5)=0.6; xє[0.5;1.5]";
            // 
            // MyForm
            // 
...
#pragma endregion
    ...
    private:
        ...
        {
            return x + std::cos(y / 7.0); // Рівняння y' = x + cos(y / 7)
        }
    ...
    private: System::Void button1_Click(System::Object^ sender, System::EventArgs^ e)
    {
        try
        {
            double x0 = 0.5; // Початкове значення x
            double y0 = 0.6; // Початкове значення y
            double h = Convert::ToDouble(textBox3->Text); // Крок
            double xEnd = 1.5; // Кінцева точка x
